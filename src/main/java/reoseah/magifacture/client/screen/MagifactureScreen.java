...
public abstract class MagifactureScreen<T extends MagifactureScreenHandler> extends HandledScreen<T> {
    private final List<TankDisplay> tanks = new ArrayList<>();
    ...
    protected TankDisplay addTankDisplay(SingleFluidStorage tank, int x, int y, int width, int height) {
        TankDisplay display = new TankDisplay(tank, x, y, width, height);
    ...
    protected void drawBackground(MatrixStack matrices, float delta, int mouseX, int mouseY) {
        ...
        for (TankDisplay tank : this.tanks) {
    ...
    public static final class TankDisplay {
        ...
        public TankDisplay(SingleFluidStorage tank, int x, int y, int width, int height) {
            this.tank = tank;
            this.x = x;
            this.y = y;
            this.width = width;
