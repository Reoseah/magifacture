...
import reoseah.magifacture.mixin.FluidAccessor;
...
public class FluidClientUtils {
    ...
    public static void drawFluidColumn(MatrixStack matrices, FluidVariant fluid, int x, int y, int height, int z) {
        VertexConsumerProvider.Immediate immediate = VertexConsumerProvider.immediate(new BufferBuilder(256));
        drawFluidColumn(matrices, immediate, fluid, x, y, height, z);
        immediate.draw();
    }

    public static void drawFluidColumn(MatrixStack matrices, VertexConsumerProvider consumers, FluidVariant variant, int x, int y, int height, int z) {
